<p class="my-3 px-12 text-center">Want us to email you occasionally with FLiK news?
</p>
...
<div class="relative mx-auto inline-block lg:bg-gray-100">
    ...
    <form method="POST" action="/newsletter" class="text-sm lg:flex">
        ...
        <button type="submit"
                class="flex items-center py-2 px-14 text-xl text-black font-semibold transition-colors duration-300 lg:mt-0 lg:ml-3" style="background-color: #C5A55A;"
            >
            Subscribe
